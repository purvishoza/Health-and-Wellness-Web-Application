...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="form1" runat="server" class="border-class" >
        ...
        <div class="row form-group" style="font-size:12pt">
                <p>I, <asp:label id="name" runat="server"/> <%# ManipulateLabel() %>  authorize S.P.A.C.E. Center Chiropractic to release my Protected Health Information, as described below, to:</p>
                <p>I request that my appointments be called and/or emailed to me at the following: (CHECK ALL THAT APPLY):</p>
            </div>
        <div class="row form-group" style="font-size:12pt">

                <asp:CheckBox ID="WorkEmailOK" runat="server" Text=" Work Email Address:" checked/><br />
                <asp:CheckBox ID="HomeEmailOK" runat="server" Text=" Home Email Address:" checked/><br />
                <asp:CheckBox ID="WorkTeleOK" runat="server" Text=" Work Telephone:" checked/><br />
                <asp:CheckBox ID="WorkAnsOK" runat="server" Text=" Work Telephone Answering Machine:" checked/><br />
                <asp:CheckBox ID="HomeTeleOK" runat="server" Text=" Home Telephone:" checked/><br />
                <asp:CheckBox ID="HomeAnsOK" runat="server" Text=" Home Telephone Answering Machine:" checked/><br />
                <asp:CheckBox ID="CellTeleOK" runat="server" Text=" Cell Telephone:" checked/><br />
                <asp:CheckBox ID="CellAnsOK" runat="server" Text=" Cell Telephone Answering Machine:" checked/><br />
                <asp:CheckBox ID="CellSMSOK" runat="server" Text=" Cell Telephone SMS messages:" checked/><br />
            </div>
        ...
        <div class="row form-group" style="font-size:12pt">
                ...
                <asp:CheckBox ID="ExamResultsOK" runat="server" Text=" Examination Results," checked/>
                <asp:CheckBox ID="HealthFitnessOK" runat="server" Text=" Health and/or Fitness Reports, or" checked/>
                ...
                <asp:CheckBox ID="IndivRequestsOK" runat="server" Text=" At the request of the individual (no purpose need be specified)" checked/><br />
                <asp:CheckBox ID="MedicalCareOK" runat="server" Text=" Additional Medical Care " checked/><br />
        ...
        <div class="row form-group" style="font-size:12pt">
         ...
         <div class="row form-group" style="font-size:12pt">
            <br />
                <a href="Policies.doc">Click Here For Policies and Procedures</a>
                <br />
        ...
        <hr />
            <div class="form-group">
                <asp:Button runat="server" ID="save" class="button btn btn-primary center-block" value="Save" Text="Save" OnClick="save_hippa_info"/>
