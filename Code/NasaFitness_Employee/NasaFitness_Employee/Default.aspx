...
<body onload="HideDiv('fa')">
     <header>
           <center><h1 style="text-align:center;color:white;font-family:Georgia Bold;margin-left:0;font-size:50PX">NASA Fitness, LLC</h1></center> 
	...
	<div class="login-html">
		...
		<div class="login-form">
			<div class="sign-in-htm">
                ...
                <!-- <div class="group">
                    <asp:Button runat="server" class="button" value="Schedule an Appointment" Text="Schedule an Appointment" OnClientClick="window.open('https://app.acuityscheduling.com/schedule.php?owner=13410900'); return false;"/>
                </div>

                <div class="group">
                    <asp:Button runat="server" class="button" value="Online Payment" Text="Online Payment" OnClientClick="window.open('http://www.spacechiro.com/SpaceChiro_Order_form.htm'); return false;"/>
                </div> --->
			...
			<div class="sign-up-htm">
               ...
               <div class="group">
					<label for="pass" class="label">Phone Number</label><br />
                    <asp:TextBox runat="server" id="phn" class="input"></asp:TextBox>
