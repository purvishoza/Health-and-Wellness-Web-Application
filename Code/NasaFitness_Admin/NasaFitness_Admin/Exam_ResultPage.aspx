...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container" runat="server">
        ...
        <div class="row">
            <p>Time taken: <span id="time" runat="server"></span> Hours.<br /><a class="btn btn-warning btn-lg" href="index.aspx" role="button" style="float:right;margin-right:25%">Back</a></p>
