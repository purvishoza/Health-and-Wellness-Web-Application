<%@ Page Language="C#"  AutoEventWireup="true" MasterPageFile="MasterPage.master" Inherits="Problem_list" Codebehind="Problem_list.aspx.cs" %>
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server" EnablePageMethods="true" />
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <h1 style="color: #093965;">Health Inventory</h1>
                    <hr />
                   <br /><br />
...
$( "#clear" ).click(function() {
  ...
  x[i].value = "";
        ...
        window.location = "Health.aspx?id="+id+"&date="+date+"&status="+status+"&dp="+dp+"&prob="+prob;
            });
