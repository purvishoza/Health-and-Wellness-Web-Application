...
public partial class ObjectiveFindingsExam : System.Web.UI.Page
{
    ...
    protected void orthSave_Click(object sender, EventArgs e)
    {
        string ort_cer = " ";
        string ort_cervi = " ";
        string ort_soto_hall = " ";
        string ort_nrc_fora_com_l = " ";
        string ort_nrc_fora_com_r = " ";
        string ort_nrc_cer_dis = " ";
        string ort_nrc_max_cer_com = " ";
        string ort_nrc_shou_dep_l = " ";
        string ort_nrc_shou_dep_r = " ";
        string ort_ivd_deje_triad = " ";
        string ort_ivd_swa = " ";
        string ort_nvc_vba_l = " ";
        string ort_nvc_vba_r = " ";
        string ort_nvc_ad_l = " ";
        string ort_nvc_ad_r = " ";
        string ort_nvc_shou_com_l = " ";
        string ort_nvc_shou_com_r = " ";
        string ort_nvc_wri_hyp_l = " ";
        string ort_nvc_wri_hyp_r = " ";
        string ort_thora = " ";
        string ort_lam = " ";
        string ort_ner_bec_l = " ";
        string ort_ner_bec_r = " ";
        string ort_ner_kem_l = " ";
        string ort_ner_kem_r = " ";
        string ort_ner_slr_l = " ";
        string ort_ner_slr_r = " ";
        string ort_ner_ely_l = " ";
        string ort_ner_ely_r = " ";
        string ort_ner_vel_l = " ";
        string ort_ner_vle_r = " ";
        string ort_sij_gae_l = " ";
        string ort_sij_gae_r = " ";
        string ort_sij_yeo_l = " ";
        string ort_sij_yeo_r = " ";
        string ort_sij_hoo_l = " ";
        string ort_sij_dlr = " ";
        string ort_ner_ll = " ";
        string ort_ner_cm_mar_l = " ";
    ...
    {
        //declaration
        string ins_spline_obs = " ";
        string ins_sub_mus_l = " ";
        string ins_sub_mus_r = " ";
        string ins_scm_mus_l = " ";
        string ins_scm_mus_r = " ";
        string ins_para_mus_ct_l = " ";
        string ins_para_mus_ct_r = " ";
        string ins_ls_spine_obs = " ";
        string ins_tra_mus_ut_l = " ";
        string ins_tra_mus_ut_r = " ";
        string ins_tra_mus_mt_l = " ";
        string ins_tra_mus_mt_r = " ";
        string ins_tra_mus_lt_l = " ";
        string ins_tra_mus_lt_r = " ";
        string ins_para_mus_tl_l = " ";
        string ins_para_mus_tl_r = " ";
        string ins_piri_mus_l = " ";
        string ins_piri_mus_r = " ";
        string ins_glu_mus_l = " ";
        string ins_glu_mus_r = " ";
        //
