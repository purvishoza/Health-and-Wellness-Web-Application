...
public partial class FitnessObjectiveFindingsExam : System.Web.UI.Page
{
    ...
    protected void nuerologicalSave_Click(object sender, EventArgs e)
    {
        ...
        {
            string strQuery = "UPDATE objectiveFindingsExam SET empid=@empid,problem = @problem,problemstartdate=@probdate,problemreviewdate=@probReviewDate,neu_cer_bic_l=@ncbl, neu_cer_bic_r=@ncbR, neu_cer_est_c=@ncec,neu_cer_bra_l=@ncbl1,neu_cer_bra_r=@ncbr,neu_cer_tri_l=@nctl,neu_cer_tri_r=@nctr,neu_cer_mus_str=@ncms,neu_lum_pate_l=@nlpl,neu_lum_pate_r=@nlpr,neu_lum_est_l=@nlel,neu_lum_ach_l=@nlal,neu_lum_ach_r=@nlar,neu_lum_mus_str=@nlms,neu_lum_heelwalk_l=@nlhl,neu_lum_heelwalk_r=@nlhr,neu_lum_toewalk_l=@nltl,neu_lum_toewalk_r=@nltr,neu_lum_path=@nlp,neu_lum_all_neg=@nlap  WHERE empid='" + empid + "' AND problem = '" + problem + "' AND problemstartdate = '" + problemstartdate + "' AND problemreviewdate = '" + problemreviewdate + "'";
            ...
            cmd.Parameters.Add("@ncbr", SqlDbType.VarChar).Value = neu_cer_bra_r;
            cmd.Parameters.Add("@nctl", SqlDbType.VarChar).Value = neu_cer_tri_l;
            cmd.Parameters.Add("@nctr", SqlDbType.VarChar).Value = neu_cer_tri_r;
            cmd.Parameters.Add("@ncms", SqlDbType.VarChar).Value = neu_cer_mus_str;
            cmd.Parameters.Add("@nlpl", SqlDbType.VarChar).Value = neu_lum_pate_l;
