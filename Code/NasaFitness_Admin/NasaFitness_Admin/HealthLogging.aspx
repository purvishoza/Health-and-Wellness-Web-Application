<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="MasterPage.master" EnableViewState="true" Inherits="HealthLogging" Codebehind="HealthLogging.aspx.cs" %>
                ...
                <div class="col-md-10 col-xs-10">
                    <ul class="nav nav-tabs">
                        ...
                        <li role="presentation" class="active">
                            <asp:LinkButton runat="server" Text="Prescription History for Health Issues" ></asp:LinkButton></li>
                        <li role="presentation" >
