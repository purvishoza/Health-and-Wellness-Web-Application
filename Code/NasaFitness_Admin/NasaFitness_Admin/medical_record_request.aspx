<%@ Page Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" Inherits="medical_record_request" EnableEventValidation="false" Codebehind="medical_record_request.aspx.cs" %>
		    ...
		    if (a.filter(":checked").length == 0) {
		        ...
		        if ($('#select-all').is(":checked")) {
		            ...
		            if (conf == true) {
		                ...
		                $.ajax({
		                    type: "POST",
		                    url: "medical_record_request.aspx/Delete",
		                    data: dataValue,
...
"orderable": false
		...
		$('#mail_send').click(function () {
		    ...
		    if ($('#email').val() == "") {
		        ...
		        $.ajax({
		            type: "POST",
		            url: "medical_record_request.aspx/SendMail",
		            data: dataValue,
		            contentType: 'application/json; charset=utf-8',
		            dataType: 'json',
		            error: function (XMLHttpRequest, textStatus, errorThrown) {
        ...
        $('.sel').click(function() {
        var name = $(this).html(); 
        window.location = "medical_record_request.aspx?name="+name;
        });
